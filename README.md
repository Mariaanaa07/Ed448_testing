...
Project Overview
This project focuses on the research and automated testing of the Ed448 (Edwards-curve Digital Signature Algorithm), based on the Edwards448 elliptic curve. It was developed as part of a software testing course in the field of cybersecurity to demonstrate modern CI/CD practices and cryptographic verification.

Key Features
Correctness Testing: Verification of key generation, signing, and signature verification processes according to the RFC 8032 standard.
